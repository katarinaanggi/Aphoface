...
echo $produk;
//Asign a query
$query = " SELECT * FROM produk WHERE produk_name LIKE '%$produk%'";
...
while ($row = $result->fetch_object()){
  ...
  echo '<div class="text-center"><a id="atcbutton" href="cart.php?id_produk='.$row->id_produk.'" class="btn btn-warning">ADD TO CART</a></div>';
  echo '</div>';
  echo '</div>';
  echo '</div>';
}
