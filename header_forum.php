   ...
   ?>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#efdddf;">
          ...
          <div class="mx-auto order-0">
            <input class="form-control mr-sm-2" type="text" id="keyword" onkeyup=searchKeyword(this.value) placeholder="&#xF002; Search" style="font-family:'Poppins', FontAwesome" />
          </div>
